...
//		log.info("memberId" + memberId);
	...
	@GetMapping("/api/diary/emotion/{diaryId}")
	@ResponseBody
	public Map<String, String> getDiaryEmotion(@PathVariable("diaryId") int diaryId) {
		Map<String, String> response = new HashMap<>();

		Diary diary = diaryService.getDiaryInfo(diaryId);
		String emotion = diary.getDiaryEmotion();
        //response.put("emotion", emotion != null ? emotion : "");
